...
ui <- shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
        ...
        conditionalPanel(condition = "input.options == 1 | input.options == 2",
        ...
        conditionalPanel(condition = "input.options == 3",
            ...
            p("This tab lets you visualize historical trends in the sentiment of Fed speeches. The statistics
              plotted here were generated by applying AFINN and NRC dictionaries to all speeches from 2006
              through February 2020. The points are the scores for the individual speeches, while the line
              represents an estimate of the overall trend in those scores across time.",
              style = "font-family: 'georgia';"),

            br(),

            p("Pick an emotion or statistic to plot."),
    ...
    mainPanel(
        ...
        tabsetPanel(id = "options", type = "tabs", selected = 1,

            tabPanel("Stats", value = 1,

                plotOutput("plot_composite", width = "100%")

            ),

            tabPanel("Annotated text", value = 2,
            ...
            tabPanel("Historical sentiment trends", value = 3,

                br(),

                plotOutput("plot_sentiment_trends", width = "100%", height = "300px")
