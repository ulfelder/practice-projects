...
ui <- navbarPage(inverse = TRUE, windowTitle = "Fedspeak",
                 ...
                 tabPanel("Sentiments",
                          ...
                          indicate stronger emotion."),
                                                p("The plot on the bottom left shows the 15 most common stemmed terms in the speech (after removing \"U.S.\", \"Federal\", and \"Reserve\")."),
                                                p("The plots on the bottom right show the distribution of words in the selected speech relative to
                          each lexicon: NRC emotions on the top, AFINN sentiment scores on the bottom"),
                                                style = "font-family: verdana;")
                                          ...
                                          mainPanel(
                                            ...
                                            plotOutput("sentiment_plot_composite", height = "600px")
